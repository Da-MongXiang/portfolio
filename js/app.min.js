...
var cards = [
  {
    ...
    html: `<div class="profile-image"><img src="${imagePath}/selfie.jpg" alt="Bryan Smith"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Jason Ramirez</td></tr>
  ...
  },
  {
    ...
    html: `
			<table>
				<tbody>
					<tr><td>NorthBuilt SoŌware Development, NY</a></td><td>Contract</td><td>2016 - 2017</td><td><a href="#" onclick="modal(event)" data-title="Arter Oy">Full Report</a></td></tr>
					<tr><td>Thoughtbot, NY</a></td><td>REMOTE</td><td>2017 - 2020</td><td><a href="#" onclick="modal(event)" data-title="Oivan">Full Report</a></td></tr>
					<tr><td>Altman Solon, MA</td><td>Remote</td><td>2020 - 2024</td><td><a href="#" onclick="modal(event)" data-title="Working from home">Full Report</a></td></tr>
				</tbody>
			</table>
		`,
  },
...
if (window.location.pathname !== "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'load profile -firstName "Jason" -lastName "Ramirez"',
        typing: true,
      },
      {
        text: "loading...",
